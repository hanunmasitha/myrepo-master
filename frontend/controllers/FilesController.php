...
class FilesController extends Controller
{
    ...
    public function actionView($id)
    {
		...
		if ($model3->load(Yii::$app->request->post())) {
            ...
            $model3->save();
            return $this->redirect(['view', 'id' => $model3 ->files_id,]);
        }
           ...
           // return $this->redirect(['view', 'id' => $model4 ->files_id,]);
    ...
    public function actionDelete($id)
    {
        ...
        return $this->redirect(['users/view', 'id' => $_SESSION['id']]);
    }
